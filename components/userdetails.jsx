    ...
    <div className={styles.action}>
      <div className={styles.profile} onClick={() => handlers.toggle()}>
        ...
        />} opened={opened} onOpen={handlers.open} onClose={handlers.close}>
          ...
          <Menu.Item onClick={() => Router.push(`/dashboard`)} icon={<FontAwesomeIcon icon={faColumns}/>}>Dashboard</Menu.Item>
          <Menu.Item onClick={() => Router.push(`/guilds`)} icon={<FontAwesomeIcon icon={faServer}/>}>Guilds</Menu.Item>
          <Menu.Item onClick={() => Router.push(`/polls`)} icon={<FontAwesomeIcon icon={faPen}/>}>Polls</Menu.Item>
          <Divider />
